...
export type BlogPageQueryQuery = { remark: { posts: Array<{ post: (
        Pick<MarkdownRemark, 'html'>
        & { frontmatter?: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'hidden' | 'layout' | 'title' | 'path' | 'category' | 'tags' | 'description' | 'date'>
...
export type LandingPageQueryQuery = { profile?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixedFragment> }> }> };

export type ProfilePageQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type ProfilePageQueryQuery = { profile?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixedFragment> }> }> };
